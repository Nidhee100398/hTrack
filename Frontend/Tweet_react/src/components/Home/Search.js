...
class Search extends Component{
    ...
    getTweetsByUser = (event) => {
        axios
          .get(`https://cors-everywhere.herokuapp.com/http://tweetspringapp-env.eba-rpr7tqkk.us-west-2.elasticbeanstalk.com/api/v1.0/tweets/${this.username.current.value}`)
          .then((res) => {
